...
if(corpus === "corpus1"){
document.getElementById("corpusdisplay").innerHTML = "<br>" + corpus1;
displaymsg();
}else if(corpus === "corpus2"){
document.getElementById("corpusdisplay").innerHTML = "<br>" + corpus2;
displaymsg();
}else if(corpus === "corpus3"){
document.getElementById("corpusdisplay").innerHTML = "<br>" + corpus3;
displaymsg();
}else{
